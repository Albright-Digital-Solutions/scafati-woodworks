          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div className="flex flex-col gap-5 lg:col-span-1">
              ...
              <div className="flex gap-3 mt-1">
                ...
                <a
                  href="https://www.google.com/search?q=scafati+woodworks&amp;oq=scafati+woodworks&amp;gs_lcrp=EgZjaHJvbWUqBwgAEAAYgAQyBwgAEAAYgAQyCggBEAAYgAQYogQyBwgCEAAY7wUyBwgDEAAY7wUyBwgEEAAY7wUyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDzSAQg3NzM5ajBqN6gCCLACAfEFI800zTDanTDxBSPNNM0w2p0w&amp;sourceid=chrome&amp;source=chrome.ob&amp;ie=UTF-8"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Scafati Woodworks on Google"
                  className="w-9 h-9 rounded-full border border-wood-700 flex items-center justify-center text-stone-500 hover:border-gold-600/50 transition-all"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <path fill="#EA4335" d="M12 5.94c1.47 0 2.79.51 3.83 1.5l2.88-2.88A9.67 9.67 0 0 0 12 2a10 10 0 0 0-8.96 5.46l3.35 2.62C7.18 7.71 9.39 5.94 12 5.94Z" />
                  </svg>
