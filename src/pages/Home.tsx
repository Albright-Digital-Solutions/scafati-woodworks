    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Warm overlay — ensures text legibility over any photo */}
          <div className="absolute inset-0 bg-gradient-to-r from-cream-50 via-cream-50/90 to-cream-50/40" />
          <div className="absolute inset-0 bg-gradient-to-t from-cream-50/70 via-cream-50/20 to-transparent" />
          ...
          <div className="max-w-2xl pt-24">
            ...
            >
              ...
              <motion.h1
                ...
                className="text-5xl md:text-6xl lg:text-[5rem] font-serif font-semibold text-wood-950 leading-[1.05] mb-6 tracking-tight drop-shadow-[0_1px_2px_rgba(253,250,245,0.8)]"
              >
                Custom Cabinetry{' '}
                <span className="text-gold-gradient">&</span>{' '}
                <span className="italic font-light text-wood-800">Fine Woodworking</span>
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-lg md:text-xl text-wood-800 mb-10 leading-relaxed max-w-lg font-light drop-shadow-[0_1px_1px_rgba(253,250,245,0.6)]"
              >
