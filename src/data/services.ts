export const servicesData = [
  ...
  },
  {
    slug: 'built-ins',
    title: 'Built-Ins',
    subtitle: 'Seamlessly Integrated Into Your Architecture',
    description: 'Transform unused wall space into a stunning focal point. Our built-ins look like they were always meant to be there — because they are designed from scratch for your exact room. Libraries, home offices, window seat surrounds, and more.',
    tech: 'Carcass construction, face frames, integrated trim work.',
    features: ['Floor-to-ceiling book cases', 'Window seat surrounds', 'Home office built-ins', 'Custom trim and crown integration', 'Adjustable shelving systems'],
